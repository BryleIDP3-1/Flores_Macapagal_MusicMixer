document.addEventListener('DOMContentLoaded', function() {
    ...
    // AUDIO FUNCTIONALITIES
        ...
        function pauseAudio() {
            ...
            const speakerIcon = document.getElementById('speaker-1');
            speakerIcon.setAttribute('src', `images/Speaker_Icon.svg`);
            const speakerIcon2 = document.getElementById('speaker-2');
            speakerIcon2.setAttribute('src', `images/Speaker_Icon.svg`);
